...
zstyle ':completion:*' menu no # Disable default menu for tab completion
zstyle ':fzf-tab:complete:cd:*' fzf-preview 'ls --color $realpath' # Show preview of tab completion for folders
